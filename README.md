...
使用本程序须知以下:
1.本程序为个人练手项目,并非成熟项目
2.您可以使用本程序作为二次开发,但需保留本程序中开发者版权信息
#安装
1.将程序上传至跟目录
2.install,cache,uploaded需要7777权限
3.访问index.php即可跳到自动安装页面
如需安装到其他目录请修改templates\js\demo-config.js中的 url: './adminu/upload.php'
#演示
<a href="https://demo.imoecg.com">https://demo.imoecg.com</a>
#本程序使用 GPL V3许可证
